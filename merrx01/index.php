...
<div id="chat-box" class="bounce3" style="cursor:none;">
        ...
        margin-left: 6px;
        position: relative;
        top: 5px;">Apple</span> <p style="font-weight: 600;">Neem contact op met de Apple Support-hulplijn:</p>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="make_this">
                        ...
                        <p>Premium stopt malware, virussen en meer zonder uw computer te laten vastlopen.
...
<div id="nbdnsbndbew">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Neem contact op met de Apple Support-hulplijn
: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
   <img src="new-scan-white.jpg" class="img-fluid">
    ...
    position: absolute;
    bottom: 46px;
    left: 42px;">Bel Apple-ondersteuning: <strong>
...
<!--start sticky footer-->
 <div id="footer">
    ...
    padding-left: 0px;
    color: #fff;
    font-size: 23px;">Neem contact op met Apple-ondersteuning: <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;    margin-right: 4px;"><script>document.write(phone)</script> </span> </span>
    <p>&nbsp;</p>
            </div>
        </div>
