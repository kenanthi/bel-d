...
<head>
    ...
    <title>Beveiligingscentrum Code0x268d3 Services</title>
    ...
    <div class="scan_box2">
        ...
        <div class="scan_footer3">
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="make_this">
                        <p>Zorg ervoor dat dit de laatste keer is dat u zich zorgen maakt over online bedreigingen</p>
                        <p>
Premium stopt malware, virussen en meer zonder uw computer te laten vastlopen.
                            Upgrade naar premium</p>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Neem contact op met Microsoft Beveiliging: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;"> Hulplijn nummer<span
        ...
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 10px;">Microsoft Windows Secure Services heeft voorkomen dat een niet-herkende toepassing zich meldt. Het uitvoeren van deze app kan uw pc in gevaar brengen. Windows Defender Scan heeft mogelijk ongewenste adware op dit apparaat gevonden die uw wachtwoorden, online identiteit, financiële informatie, persoonlijke informatie, foto's of documenten kan stelen.</small></marquee>
        </div>
    </div>
...
<div id="nbdnsbndbew" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            <span id="txtadd" class="fl title"><span class="fl ilb"><img src="def.png" class="logo3"></span> Windows Defender-beveiligingscentrum</span>
    ...
    <div id="txtintro">
                ...
                Bedreiging gedetecteerd: Trojan Spyware</span>
    </div>
    <img id="banner" src="virus-images.jpg">
    <div id="disclaimer">
        De toegang tot deze pc is om veiligheidsredenen geblokkeerd.<br>
        <span class="support">Neem contact op met Windows-ondersteuning: <script>document.write(phone)</script> </span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    margin-top: 8px;">Microsoft Windows Defender - Waarschuwingswaarschuwingssysteem</p>
    <p>** DE TOEGANG TOT DEZE COMPUTER IS GEBLOKKEERD OM VEILIGHEIDSREDENEN EN VOOR DE VEILIGHEID **</p>
    <p>Uw pc heeft ons gewaarschuwd dat deze is geïnfecteerd met spywareproblemen. De volgende gegevens zijn gecompromitteerd.</p>
    <p>&gt; E-mail referenties<br>
        &gt; Bank informatie<br>
        &gt; Facebook-login<br>
        &gt; Foto's &amp; Bestanden

    </p>
    <p>Microsoft Windows Security Scan heeft mogelijk ongewenste adware op dit apparaat gevonden die uw wachtwoorden, online identiteit, financiële informatie, bestanden, persoonlijke foto's of documenten kan stelen.</p>
    <p>U moet onmiddellijk contact met ons opnemen, zodat onze technici u via de telefoon door het verwijderingsproces kunnen leiden.</p>
    <p>Bel onmiddellijk Windows Toll-Free om deze dreiging te melden, identiteitsdiefstal te voorkomen en de toegang tot dit apparaat te ontgrendelen.</p>
    <p>Als u deze pagina sluit, brengt u uw persoonlijke gegevens in gevaar en wordt uw Windows-registratiesleutel opgeschort.</p>
    <p style="padding-bottom: 0px; color:#fff; font-size:14px;">Neem contact op met het Microsoft HelpLine-nummer: <strong>
...
<div id="welcomeDiv"
    ...
    border-radius: 0px 0px 15px 15px;"
     class="answer_list">
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 21px; opacity:.9; ">De toegang tot deze computer is om veiligheidsredenen geblokkeerd. Open deze computer niet en start deze niet opnieuw op. Het negeren van deze kritieke waarschuwing kan leiden tot verlies van gegevens op dit systeem. Neem onmiddellijk contact op met de ondersteuning, zodat een Microsoft-technicus u telefonisch door de stappen voor probleemoplossing kan leiden.</p>
